 ...
 * ```
 */
export type { FileStats, FileEntry, FileSystemBackend, FileSystemEvent, FileSystemEventHandler, WriteOptions, WriteBinaryBatchEntry, WriteBinaryBatchOptions } from './types.js';
export type { BackendPreference, MountOptions } from './FileSystemService.js';
export { fileSystem, FileSystemService, isOPFSAvailable, getBestBackend, getBackend } from './FileSystemService.js';
export { OPFSBackend, opfsBackend } from './OPFSBackend.js';
export { IndexedDBBackend, indexedDBBackend } from './IndexedDBBackend.js';
export { IDB_NAME, IDB_VERSION, IDB_FILES_STORE, IDB_DIRS_STORE, OPFS_ROOT } from './constants.js';
